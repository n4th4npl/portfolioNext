  ...
  className="group mb-3 sm:mb-8 last:mb-0 "
    ...
    >
      <section className="bg-gray-100 rounded-md cursor-pointer max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem]">
        ...
        <Image
          className="absolute top-8 -right-40 w-[28.25rem] group-hover:scale-[1.04] group-hover:-rotate-2 transition group-hover:-translate-x-3 group-hover:translate-y-3
